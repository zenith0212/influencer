...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
   <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
      <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
         <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View Campaign Details</h1>
         <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item text-muted">
               <a href="{{route('campaigns.index')}}" class="text-muted text-hover-primary">Campaign</a>
            </li>
         </ul>
      </div>
   </div>
         ...
         <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
               <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                  ...
                  @else
                  <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{ asset('assets/media/avatars/default_img.png') }})">
                  </div>
                  @endif
               </div>
            ...
            <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
               <div class="d-flex flex-column gap-7 gap-lg-10">
                  <div class="card card-flush py-4">
                     <div class="card-header">
                        <div class="card-title">
                           <h2>{{ ucfirst($campaigns->name_en) }}</h2>
                        </div>
                     </div>
                     <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                           <div class="text-group">
                              <label class="form-label">Fans Range :</label>
                        ...
                        <div class="mb-10 fv-row">
                           <div class="text-group">
                              ...
                              <p> {{ $campaigns->total_influencers_required }}</p>
                           </div>
                        </div>
                        <div class="mb-10 fv-row">
                           <div class="text-group">
                              <label class="form-label"> Description:</label>
                              <p> {{ $campaigns->description_en }}</p>
                           </div>
                        </div>
                        <div class="mb-10 fv-row">
                           <div class="text-group">
                           ...
                           <div class="d-flex flex-wrap flex-sm-nowrap">
                              ...
                              <div class="me-7 mb-2">
                                 ...
                                 @if ( $product->mainImage )
                                    <img src="{{  asset("storage/{$product_path}/{$product->id}/{$product->mainImage->image}")}} " alt="image" height="50" width="50">
                                 </div>
                                 @else
                                    <img src="{{  asset('assets/media/avatars/default_img.png') }} " alt="image" height="50" width="50">
                                 @endif
                              </div>
                              <!--end::Pic-->
                              <!--begin::Info-->
                                 ...
                                 <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                       ...
                                       <div class="d-flex align-items-center mb-2">
                                          <a href="javascript:void(0);" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1"> {{ ucfirst($product->name_en) }}
                                          </a>
                                          <a href="javascript:void(0);" class="text-gray-500 text-hover-primary fs-2 fw-semibold me-1">( {{ ucfirst($product->keyword_en) }} )
                                          </a>
                                       </div>
                                       <!--end::Name-->
                                       <!--begin::Info-->
