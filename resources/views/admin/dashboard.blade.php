                ...
                <div class="row gy-5 g-xl-10">
                        ...
                        <div class="card">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $brand_count }}</span>
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Total Brands</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="m-0">
                                    <span class="svg-icon svg-icon-5tx svg-icon-info">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $influencer_count }}</span>
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Total Influencers</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $plan_count }}</span>
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Total Plans</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-column my-7">
                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $category_count }}</span>
                                    <div class="m-0">
                                        <span class="fw-semibold fs-6 text-gray-400">Total Categories</span>
                                    </div>
                                </div>
                            </div>
                        </div>
