...
<main>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-5">
                        <div class="banner-img">
                            <img src="{{asset('assets/images/content/service-banner-img.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="what-results-we-provide section-top-space section-bottom-space">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 order-1 order-lg-0">
                        <div class="service-content-img">
                            <img src="{{asset('assets/images/content/what-results-we-provide.png')}}" alt="">
                        </div>
                    </div>
        
                    <div class="col-lg-6 order-0 order-lg-1">
                        <div class="service-content">
                            <h3 class="section-heading">What results do we provide?</h3>
                            <p>We help brands make a breakthrough on their sales performance using our influencer marketing platform. The brand awareness has also improved after cooperating with the influencers. This is exactly the meaning of our platform.</p>
                            <a href="" class="primary-btn">Join Us</a>
                        </div>
                    </div>
                </div>
