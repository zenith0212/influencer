                        ...
                        <div class="d-flex flex-column flex-center w-md-500px">
                            <div class="bg-body rounded-4  d-flex flex-center flex-column align-items-stretch  w-md-400px p-10 rounded-4 login_right_inner">
                                <div class="d-flex flex-center flex-column-fluid">                                    
                                    <form class="form w-100"  id="testForm"  method="post" action="{{ route('password.email') }}">
                                    @csrf
                                    @method('POST')
                                        <div class="text-center mb-11">
                                            <h1 class="text-dark fw-bolder mb-3" style="font-size: 12px;"> {{ __('Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.') }}</h1>
                                        </div>
                                        <div class="fv-row mb-8">
                                            <input type="email" placeholder="Email" name="email" id="email" class="form-control bg-transparent" :value="old('email')" required />
                                            @error('email')
                                        ...
                                        <x-auth-session-status class="mb-4 mt-2" style="color: red; font-weight: 600;" :status="session('status')" />
