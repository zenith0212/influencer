                                                        ...
                                                        <table class="action" align="center" width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; margin: 30px auto ; padding: 0 ; text-align: center ; width: 100%"> 
                                                            <tbody>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr> 
                                                                        <td style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative"> <a href="{{ url('invitemail') }}/{{ $campaigns->id }}/{{ $influencer_id }}/{{ $accept }}" class="button button-primary" style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; border-radius: 4px ; color: #fff ; display: inline-block ; overflow: hidden ; text-decoration: none ; background-color: #F26546 ; border-bottom: 8px solid #F26546 ; border-left: 18px solid #F26546 ; border-right: 18px solid #F26546 ; border-top: 8px solid #F26546" rel="nofollow">Accept</a> </td> 

                                                                        <td style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative"> <a  href="{{ url('invitemail') }}/{{ $campaigns->id }}/{{ $influencer_id }}/{{ $reject }}" class="button button-primary" 
                                                                        style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; border-radius: 4px ; color: #fff ; display: inline-block ; overflow: hidden ; text-decoration: none ; background-color: #F26546 ; border-bottom: 8px solid #F26546 ; border-left: 18px solid #F26546 ; border-right: 18px solid #F26546 ; border-top: 8px solid #F26546;margin-left:10px" rel="nofollow">Reject</a> </td> 
                                                                        </tr> 
                                                                    </tbody>
                                                                    </table> </td> 
                                                                    </tr> 
