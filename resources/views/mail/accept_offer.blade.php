                            ...
                            <tbody>
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; background-color: #ffffff ; border-color: #e8e5ef ; border-radius: 5px ; border-width: 1px ; box-shadow: 0 2px 0 rgba(0 , 0 , 150 , 0.025) , 2px 4px 0 rgba(0 , 0 , 150 , 0.015) ; margin: 0 auto 30px; padding: 0 ; width: 570px"> 
                                    ...
                                    <tbody>
                                        ...
                                        </table> <p style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; font-size: 16px ; line-height: 1.5em ; margin-top: 0 ; margin-bottom: 25px;  text-align: left"><b>Congratulations!!!</b><br/>{{$UserName }} influencer has accepted your offer for joining <b>{{ $CampName }}</b> Campaign.</p> <p style="box-sizing: border-box ; font-family: blinkmacsystemfont , segoe ui , roboto , helvetica , arial , sans-serif , apple color emoji , segoe ui emoji , segoe ui symbol ; position: relative ; font-size: 16px ; line-height: 1.5em ; margin-top: 0 ; text-align: left">Regards,<br> Influencer Marketing</p>  
