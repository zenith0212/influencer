    ...
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
        ...
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
            ...
            <a href="{{ route('admin.dashboard')}}">
                <img alt="Logo" src="{{ asset('assets/media/logos/topbrandmate.png') }}" class="h-25px app-sidebar-logo-default" />
                <img alt="Logo" src="{{ asset('assets/media/logos/small-topbrandmate.png') }}" class="h-20px app-sidebar-logo-minimize" />
            </a>
            <!--end::Logo image-->
            ...
            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ is_active_menu(['plans.index']) }}" href="{{ route('plans.index') }}">
                            ...
                            <!--end:Menu link-->
                            <!--begin:Menu link-->
                            <a class="menu-link {{ is_active_menu(['categories.index']) }}" href="{{ route('categories.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ is_active_menu(['brand_users']) }}" href="{{ route('brand_users') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <!--end:Menu link-->
                            <!--begin:Menu link-->
                           <!--  <a class="menu-link {{ is_active_menu(['influencers']) }}" href="{{ route('influencers') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Influencers</span>
                            </a> -->
                            <!--begin:Menu item-->
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <!--begin:Menu link-->
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link {{ is_active_menu(['influencers']) }}" href="{{ route('influencers') }}">
                                            ...
                                            <span class="menu-title">Tiktok Influencers</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link {{ is_active_menu(['register_influencers']) }}" href="{{ route('register_influencers') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Registered Influencers</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ is_active_menu(['products.index']) }}" href="{{ route('products.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ is_active_menu(['campaigns.index']) }}" href="{{ route('campaigns.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Campaign Details</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                {{-- Manage payments --}}
                <div class="menu-item">
                    <a class="menu-link {{ is_active_menu(['payments.index']) }}" href="{{ route('payments.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                ...
                <!-- Manage meta content -->
                <div class="menu-item">
                    <a class="menu-link {{ is_active_menu(['content.index']) }}" href="{{ route('content.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Frontend Requests</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ is_active_menu(['front.common']) }}" href="{{ route('front.common') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Request Demo/Contact Us</span>
                            </a>
                        </div>
                    </div>
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ is_active_menu(['front.joinus']) }}" href="{{ route('front.joinus') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
