      ...
      <div class="d-flex flex-column flex-column-fluid">
         <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="container-fluid">
               <form id="search_connected_campaign">
                  <div class="card mb-7">
                     <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-column flex-md-row">
                           <div class="position-relative w-100 me-md-4 search_name_css">
                              <span class="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute top-50 translate-middle ms-6">
                                 ...
                                 <input type="text" class="form-control form-control-solid ps-10 search_connected_name" name="name" id="search_connected_name" value="" placeholder="Search Campaign">
                              </div>
                              <div class="d-flex align-items-center">
                                 <button type="submit" id="search_connected" class="primary-btn mt-5 mt-md-0">Search</button>
                              </div>
                           </div>
                              ...
                              <div class="card campaigns-card border-1 h-100">
                                 <div class="card-body d-flex align-items-center justify-content-start flex-column">
                                    <div class="symbol symbol-65px symbol-circle mb-5">
                                       @if(!empty($campaigns->campaigns->thumbnail_image))
                                       <img src="{{ asset('/storage/campaign_images/'.$campaigns->campaigns->thumbnail_image) }}" alt="image">
                                       @else
                                       <img src="{{ asset('/assets/media/avatars/default_img.png')  }}" alt="image">
                                       @endif
                                       @if($campaigns->campaigns->campaign_is_active == 1)
                                    ...
                                    <a href="{{ route('influencer.campaign_details',$campaigns->campaigns->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0 campaig-name-title">{{ ucfirst($campaigns->campaigns->name_en) }}</a>
                                    <div class="fw-semibold text-gray-400 mb-6"> {{ucfirst($campaigns->campaigns->short_description_en)}} </div>
                                    <div class="d-flex flex-center flex-wrap">
                                       <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 text-center">
                                          <div class="fs-6">$ {{ $campaigns->campaigns->amount }}</div>
                                          <div class="fw-semibold text-gray-400">Price</div>
                                       </div>
                                       <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 text-center">
                                          <div class="fs-6">{{ getFans($campaigns->campaigns->min_fans) }} - {{ getFans($campaigns->campaigns->max_fans) }}</div>
                                          <div class="fw-semibold text-gray-400">Fans Range</div>
                                       </div>
                                       <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 text-center">
                                          @if( $campaigns->campaigns->is_video == 0)
                                          <div class="fs-6">No streaming required</div>
                                          @elseif($campaigns->campaigns->is_video == 1)
                 ...
                 {{--  @if($display_campaign_count>0)
                  <div class="d-flex flex-center" id="remove-row">
                     <a href="javascript:void(0);" class="primary-btn fw-bold px-6 mt-5" id="kt_social_feeds_more_posts_btn" >
                        <input type="hidden" id="loader_id" value="{{ $campaigns->campaigns->id }}"/>
