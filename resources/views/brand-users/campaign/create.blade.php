...
<main class="create-campaign">
    <div class="container-fluid">
        <div class="content">
            ...
            <!-- form section -->
            <form action="{{ route('brand.campaign.store') }}" class="create_campaign_form" enctype="multipart/form-data" method="post" autocomplete="off">
                ...
                <!-- step-2 section  -->
                <section id="section2" class="section2 dfs section-content">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group ">
                                            ...
                                            <div class="inputfile-box">
                                                <input type="file" name="product_main_image" id="product_main_image" class="inputfile form-control" data-multiple-caption="{count} files selected" multiple />
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check-row">
                                    <div class="form-check">
                                        <input class="form-check-input check-only-one-sample-video" name="is_sample_required" type="checkbox" value="1" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                             Yes
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input check-only-one-sample-video" name="is_sample_required" type="checkbox" value="0" id="flexCheckChecked">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="amount" id="amount" placeholder="1000">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="total_influencers_required" name="total_influencers_required" placeholder="10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="budget_for_each_influencer" name="budget_for_each_influencer" placeholder="100" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div>
                                        <img class="w-100 rounded" id="preview_image" src="{{ $defaultImgUrl }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check-row d-block">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input check-only-one-live-streaming" name="is_video" type="checkbox" value="1" id="normal">
                                        <label class="form-check-label" for="normal">
                                             Normal
                                        </label>
                                      </div>
                                      <div class="form-check mb-3">
                                        <input class="form-check-input check-only-one-live-streaming" name="is_video" type="checkbox" value="2" id="video">
                                        <label class="form-check-label" for="video">
                                              Video
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input check-only-one-live-streaming" name="is_video" type="checkbox" value="3" id="live_streaming">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="application_till_date" name="application_till_date" class="form-control floating-label" placeholder="04/20/2023">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-check-row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="tikTok-check" checked>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="terms_and_condition_en" id="terms_and_condition_en" rows="10" cols="10" ></textarea>
                                <input type="hidden" name="hidde_tc" id="hidde_tc" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="promote" name="promote" placeholder="Promote">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="traceable_link" class="form-label">Traceable Link<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="traceable_link" name="traceable_link" placeholder="https://www.google.com">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="form-check-row">
                                    <div class="form-check">
                                        <input class="form-check-input check-only-one-on-going" name="campaign_is_active" type="checkbox" value="1" id="ongoing_yes">
                                        <label class="form-check-label" for="ongoing_yes">
                                             Yes
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input check-only-one-on-going" name="campaign_is_active" type="checkbox" value="0" id="ongoing_no">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="application_start_date" name="application_start_date" class="form-control floating-label" placeholder="Start Date">
                        ...
                        <div class="col-lg-4 campaign-end-date-portion">
                            <div class="form-group">
                                ...
                                <input type="text" id="application_end_date" name="application_end_date" class="form-control floating-label" placeholder="End Date">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-example-basic-multiple" id="add_emails" name="add_emails[]" multiple="multiple">
                                                    @foreach ($allInfluencerUser as $influencerUser)
                                                        <option value="{{ $influencerUser->id }}">{{ $influencerUser->email }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                ...
                <div class="button-container">
                    <button type="button" class="btn-prev steps-btn disabled"> <div><i class="fa-solid fa-chevron-left"></i> <i class="fa-solid fa-chevron-left"></i></div> <span>Previous</span></button>
...
@section('script')
<script>
    let store_route     = "{{ route('brand.campaign.store')}}";
...
<script src="{{ asset('brand_campaign/js/create-campaign.js') }}"></script>
@endsection
